    ...
    wx.miniProgram.getEnv((res) => {
      if (res.miniprogram) {
        ...
        if (0) {
          ...
          if (
            url.indexOf("go/u3/") != -1 ||
            url.indexOf("https://u3.huatu.com/uploads/soft/") != -1
          ) {
            //alert('华图提醒你正在下载2');
            //地址带有wj=1，则直接下载附件
          ...
          if (
            url.indexOf("huatu.com") == -1 &&
            url.indexOf("https://htjy") == -1
          ) {
            ...
            if (locationurl.indexOf("amp;poptype=") != -1) {
              ...
              if (
                document.getElementById("wzpoptype") ||
                locationurl.indexOf("tg=") != -1
              ) {
                wxtc(url);
              }
            }
      ...
      if (
        ...
        if (
          ...
          if (localStorage.getItem("gdht_wxlogin_type")) {
            ...
            if (
              xcxfunction != "true" &&
              window.location.href.indexOf("/zt/") != -1
            ) {
              //专题下面没开启true就不弹窗
            } else {
          ...
          //pc端
          if (
            window.location.href.indexOf("https://jiangmen.huatu.com/") != -1
          ) {
            //江门不进行关注服务号号的操作
          } else {
            if (localStorage.getItem("gdht_wxlogin_type")) {
...
function xcxforminiprom1(url) {
  ...
  if (
    alink.indexOf("go/u3") != -1 ||
    alink.indexOf("https://u3.huatu.com/uploads/soft/") != -1
  ) {
    alink = copytheu3all();
  }
  ...
  if (1) {
    ...
    document.getElementById("gzcopy").innerHTML =
      "识别二维码，微信长按粘贴内容快速打开！";
  ...
  //付款购买的显示企业号
  if (
    url.indexOf("htjy.cc") != -1 ||
    url.indexOf("xd.huatu.com") != -1 ||
    url.indexOf("xue.huatu.com") != -1 ||
    url.indexOf("v.huatucom") != -1
  ) {
  ...
  if (0) {
    ...
    if (locationurl.indexOf("gd.huatu.com") != -1) {
      ...
      //var code = getqrcode(url);
      var code = getqrcodety(
        url,
        "https://gd.huatu.com/zt/wxfwh-wl/getQRCode/"
      );
      $(".wxewm").attr("src", code);
    ...
    if (locationurl.indexOf("meizhou.huatu.com") != -1) {
      var code = getqrcodety(
        url,
        "https://gd.huatu.com/zt/wxfwh-mz/getQRCode/"
      );
      $(".wxewm").attr("src", code);
      document.getElementById("thetitle").innerHTML = "扫码获取";
      document.getElementById("tishi").innerHTML =
    ...
    if (locationurl.indexOf("maoming.huatu.com") != -1) {
      var code = getqrcodety(
        url,
        "https://gd.huatu.com/zt/wxfwh-mm/getQRCode/"
      );
      $(".wxewm").attr("src", code);
      document.getElementById("thetitle").innerHTML = "扫码获取";
      document.getElementById("tishi").innerHTML =
    ...
    if (locationurl.indexOf("chaozhou.huatu.com") != -1) {
      var code = getqrcodety(
        url,
        "https://gd.huatu.com/zt/wxfwh-cz/getQRCode/"
      );
      $(".wxewm").attr("src", code);
      document.getElementById("thetitle").innerHTML = "扫码获取";
      document.getElementById("tishi").innerHTML =
    ...
    if (locationurl.indexOf("foshan.huatu.com") != -1) {
      var code = getqrcodety(
        url,
        "https://gd.huatu.com/zt/wxfwh-fs/getQRCode/"
      );
      $(".wxewm").attr("src", code);
      document.getElementById("thetitle").innerHTML = "扫码获取";
      document.getElementById("tishi").innerHTML =
    ...
    if (locationurl.indexOf("dongguan.huatu.com") != -1) {
      var code = getqrcodety(
        url,
        "https://gd.huatu.com/zt/wxfwh-dg/getQRCode/"
      );
      $(".wxewm").attr("src", code);
      document.getElementById("thetitle").innerHTML = "扫码获取";
      document.getElementById("tishi").innerHTML =
    ...
    if (locationurl.indexOf("zhongshan.huatu.com") != -1) {
      var code = getqrcodety(
        url,
        "https://gd.huatu.com/zt/wxfwh-zs/getQRCode/"
      );
      $(".wxewm").attr("src", code);
      document.getElementById("thetitle").innerHTML = "扫码获取";
      document.getElementById("tishi").innerHTML =
    ...
    if (locationurl.indexOf("jieyang.huatu.com") != -1) {
      var code = getqrcodety(
        url,
        "https://gd.huatu.com/zt/wxfwh-jy/getQRCode/"
      );
      $(".wxewm").attr("src", code);
      document.getElementById("thetitle").innerHTML = "扫码获取";
      document.getElementById("tishi").innerHTML =
    ...
    if (locationurl.indexOf("guangzhou.huatu.com") != -1) {
      var code = getqrcodety(
        url,
        "https://gd.huatu.com/zt/wxfwh-gz/getQRCode/"
      );
      $(".wxewm").attr("src", code);
      document.getElementById("thetitle").innerHTML = "扫码获取";
      document.getElementById("tishi").innerHTML =
    ...
    if (locationurl.indexOf("shantou.huatu.com") != -1) {
      var code = getqrcodety(
        url,
        "https://gd.huatu.com/zt/wxfwh-st/getQRCode/"
      );
      $(".wxewm").attr("src", code);
      document.getElementById("thetitle").innerHTML = "扫码获取";
      document.getElementById("tishi").innerHTML =
    ...
    if (locationurl.indexOf("huizhou.huatu.com") != -1) {
      var code = getqrcodety(
        url,
        "https://gd.huatu.com/zt/wxfwh-hz/getQRCode/"
      );
      $(".wxewm").attr("src", code);
      document.getElementById("thetitle").innerHTML = "扫码获取";
      document.getElementById("tishi").innerHTML =
    ...
    if (locationurl.indexOf("zhanjiang.huatu.com") != -1) {
      var code = getqrcodety(
        url,
        "https://gd.huatu.com/zt/wxfwh-zj/getQRCode/"
      );
      $(".wxewm").attr("src", code);
      document.getElementById("thetitle").innerHTML = "扫码获取";
      document.getElementById("tishi").innerHTML =
    ...
    if (locationurl.indexOf("yangjiang.huatu.com") != -1) {
      var code = getqrcodety(
        url,
        "https://gd.huatu.com/zt/wxfwh-yj/getQRCode/"
      );
      $(".wxewm").attr("src", code);
      document.getElementById("thetitle").innerHTML = "扫码获取";
      document.getElementById("tishi").innerHTML =
    ...
    if (locationurl.indexOf("gd.huatu.com/jsks/") != -1) {
      var code = getqrcodety(
        url,
        "https://gd.huatu.com/zt/wxfwh-xm-jsks/getQRCode/"
      );
      $(".wxewm").attr("src", code);
      document.getElementById("thetitle").innerHTML = "扫码获取";
      document.getElementById("tishi").innerHTML =
    ...
    if (locationurl.indexOf("zhuhai.huatu.com") != -1) {
      var code = getqrcodety(
        url,
        "https://gd.huatu.com/zt/wxfwh-zh/getQRCode/"
      );
      $(".wxewm").attr("src", code);
      document.getElementById("thetitle").innerHTML = "扫码获取";
      document.getElementById("tishi").innerHTML =
    ...
    if (locationurl.indexOf("qingyuan.huatu.com") != -1) {
      var code = getqrcodety(
        url,
        "https://gd.huatu.com/zt/wxfwh-qy/getQRCode/"
      );
      $(".wxewm").attr("src", code);
      document.getElementById("thetitle").innerHTML = "扫码获取";
      document.getElementById("tishi").innerHTML =
    ...
    if (locationurl.indexOf("jiangmen.huatu.com") != -1) {
      var code = getqrcodety(
        url,
        "https://gd.huatu.com/zt/wxfwh-jm/getQRCode/"
      );
      $(".wxewm").attr("src", code);
      document.getElementById("thetitle").innerHTML = "扫码获取";
      document.getElementById("tishi").innerHTML =
    ...
    if (locationurl.indexOf("heyuan.huatu.com") != -1) {
      var code = getqrcodety(
        url,
        "https://gd.huatu.com/zt/wxfwh-hy/getQRCode/"
      );
      $(".wxewm").attr("src", code);
      document.getElementById("thetitle").innerHTML = "扫码获取";
      document.getElementById("tishi").innerHTML =
    ...
    if (locationurl.indexOf("zhaoqing.huatu.com") != -1) {
      var code = getqrcodety(
        url,
        "https://gd.huatu.com/zt/wxfwh-zq/getQRCode/"
      );
      $(".wxewm").attr("src", code);
      document.getElementById("thetitle").innerHTML = "扫码获取";
      document.getElementById("tishi").innerHTML =
    ...
    if (locationurl.indexOf("shanwei.huatu.com") != -1) {
      var code = getqrcodety(
        url,
        "https://gd.huatu.com/zt/wxfwh-sw/getQRCode/"
      );
      $(".wxewm").attr("src", code);
      document.getElementById("thetitle").innerHTML = "扫码获取";
      document.getElementById("tishi").innerHTML =
    ...
    if (locationurl.indexOf("maoming.huatu.com") != -1) {
      ...
      locationurl.indexOf("gd.huatu.com/sydw") != -1 ||
      locationurl.indexOf("gd.huatu.com/zt/gdsydw") != -1
    ) {
    ...
    document.getElementById("gzcopy").innerHTML =
      "识别二维码，微信关注进入对话框！" +
      "<br>对话框长按粘贴，回复内容快速打开!"; //+'或直接复制链接到浏览器打开'
    //document.getElementById('tishi').innerHTML = '小程序里不能直接打开相关链接';
  ...
  $(".xn-xcx-head img").attr(
    "src",
    "https://gd.huatu.com/zt/theshow/file/images/download.png"
  );
  ...
  if (ua.match(/MicroMessenger/i) == "micromessenger") {
    wx.miniProgram.getEnv((res) => {
      if (res.miniprogram) {
        ...
        //广东，深圳都开启关注服务号
        if (
          window.location.href.indexOf("https://shenzhen.huatu.com/") != -1 ||
          window.location.href.indexOf("https://gd.huatu.com/") != -1
        ) {
          redirect_href = url;
          loginOpen();
          event.preventDefault();
...
function getqrcode(redirect_href) {
  ...
  info.href = redirect_href.replace(
    "https://gd.huatu.com/z/go/u3/?u=",
    "https://u3.huatu.com/uploads/soft/"
  );
...
if (ua.match(/MicroMessenger/i) == "micromessenger") {
  wx.miniProgram.getEnv((res) => {
    if (res.miniprogram) {
      ...
      //微信浏览器,插入弹窗
      document.write(
        '<link rel="stylesheet" type="text/css" href="https://gd.huatu.com/zt/css.css?v=1"></link>'
      );
      var title = "相关入口";
      ...
      textEle +=
        '		<i title="关闭" id="xn_closed" onclick="close_x_wx_box()" id="xn_closed_id">x</i>';
      textEle += "	</div>";
      ...
      textEle +=
        '			<p class="tishi" id="wx_tishi2" style="color:#009688">微信关注回复口令即可进入！</p>';
      textEle += '			<img class="wxewm" id="wxewm" src="">';
      textEle +=
        '			<p class="gzcopy" id="wx_gzcopy">识别二维码，回复口令快速进入！</p>';
      textEle +=
...
if (
  window.location.href.indexOf(
    "https://m.gd.huatu.com/jsks/2023/0228/4180867.html?wximg=https://u3.huatu.com/uploads/gdht/all/2023/0228/1677578810.png&amp;poptype=1&amp;popkey="
  ) != -1
) {
  //微信浏览器,插入弹窗
  document.write(
...
function wxtc(url) {
  if (0) {
    ...
    if (locationurl.indexOf("poptype=") != -1) {
      if (
        getQueryString("amp;poptype") != "" ||
        getQueryString("amp;poptype") != null
      ) {
      ...
      if (window.location.href.indexOf("https://m.") != -1) {
        ...
        if (document.getElementsByClassName("detail-tit")) {
          if (document.getElementsByClassName("detail-tit").length > 0) {
            if (
              document
                .getElementsByClassName("detail-tit")[0]
                .innerHTML.match(/公务员|国考|省考|市考/)
            ) {
              code =
                "https://gd.huatu.com/zt/gdhttg/dsggfjewm/wxgd/广东网站附件（广东)_公务员.png";
            } else if (
              document
                .getElementsByClassName("detail-tit")[0]
                .innerHTML.match(/学校|教育|教师|老师/)
            ) {
              code =
                "https://gd.huatu.com/zt/gdhttg/dsggfjewm/wxgd/广东网站附件（广东)_教师.png";
            } else if (
              document
                .getElementsByClassName("detail-tit")[0]
                .innerHTML.match(/护士|医|卫|药/)
            ) {
              code =
                "https://gd.huatu.com/zt/gdhttg/dsggfjewm/wxgd/广东网站附件（广东)_医疗.png";
            } else if (
              document
                .getElementsByClassName("detail-tit")[0]
                .innerHTML.match(/研究生|考研/)
            ) {
              code =
                "https://gd.huatu.com/zt/gdhttg/dsggfjewm/wxgd/广东网站附件（广东)_考研.png";
            } else if (
              document
                .getElementsByClassName("detail-tit")[0]
                .innerHTML.match(/文职/)
              ...
              code =
                "https://gd.huatu.com/zt/gdhttg/dsggfjewm/wxgd/广东网站附件（广东)_军队文职.png";
            } else if (
              document
                .getElementsByClassName("detail-tit")[0]
                .innerHTML.match(/其他/)
              ...
              code =
                "https://gd.huatu.com/zt/gdhttg/dsggfjewm/wxgd/广东网站附件（广东)_事业单位.png";
            }
          }
        }
      } else {
        ...
        if (
          ...
          if (
            ...
            document.getElementsByTagName("h1")[0].innerHTML.match(/文职/)
          ) {
            code =
              "https://gd.huatu.com/zt/gdhttg/dsggfjewm/wxgd/广东网站附件（广东)_军队文职.png";
          } else if (
            document.getElementsByTagName("h1")[0].innerHTML.match(/其他/)
          ) {
            code =
              "https://gd.huatu.com/zt/gdhttg/dsggfjewm/wxgd/广东网站附件（广东)_事业单位.png";
          }
    ...
    if (0) {
      ...
      if (
        document.getElementById("wzpoptype") &&
        document.getElementById("wzwximg").value != ""
      ) {
        //文章中设定有这个隐藏的控件且值不为空
    ...
    // document.getElementById('wx_tishi').innerHTML = '小程序里不能直接打开相关链接';
    // document.getElementById('wx_tishi2').innerHTML = '微信关注回复内容快速访问';
    document.getElementById("wx_tishi2").innerHTML =
      "扫码微信关注，发送口令快速获取！";
    //document.getElementById('gzcopy').innerHTML = '识别二维码，微信关注进入对话框！'+'<br>对话框长按粘贴，回复内容快速打开!'; //+'或直接复制链接到浏览器打开'
    //document.getElementById('wx_gzcopy').innerHTML = "<p id='phonep' style='margin: 13px;' class='phonep' >识别二维码<img style='display: initial;' src='https://u3.huatu.com/uploads/allimg/230215/660653-230215161F95299461006.gif'>关注微信<img style='display: initial;' src='https://u3.huatu.com/uploads/allimg/230215/660653-230215161F95299461006.gif'>长按粘贴口令<img style='display: initial;' src='https://u3.huatu.com/uploads/allimg/230215/660653-230215161F95299461006.gif'>发送口令<img style='display: initial;' src='https://u3.huatu.com/uploads/allimg/230215/660653-230215161F95299461006.gif'>点击进入</p>"; //+'或直接复制链接到浏览器打开'
    document.getElementById("wx_gzcopy").innerHTML =
      "识别二维码，微信关注进入对话框！<br>对话框长按粘贴，发送口令快速打开！";
    ...
    //document.getElementById('wx_tishi2').innerHTML = '微信关注回复口令快速访问';
    //document.getElementById('wx_gzcopy').innerHTML = '识别二维码，微信关注回复口令快速打开！';

    //document.getElementById("wx_gzcopy").style.color = '#7a7979';
...
function copythemessage1() {
  ...
  if (locationurl.indexOf("poptype=") != -1) {
    ...
    if (
      document.getElementById("wzpoptype") &&
      document.getElementById("wzpoptype").value == 2
    ) {
      if (
        document.getElementById("wzpopkey") &&
        document.getElementById("wzpopkey").value != ""
      ) {
...
function checkRedirect(url) {
  ...
  for (var i = 0; i < document.getElementsByTagName("a").length; i++) {
    if (document.getElementsByTagName("a")[i].href == url) {
      ...
      if (!ifu3) {
        ...
        if (
          document.getElementsByTagName("a")[i].innerHTML.indexOf("img") != -1
        ) {
          alink =
            "点击下方链接进入:\r\n\r\n" +
            htitle1 +
  ...
  if (!tg) {
    if (
      document.getElementById("wzgypic") &&
      document.getElementById("wzgypic").value != ""
    ) {
  ...
  if (0) {
    ...
    if (checkAuditTime("07:00", "10:00")) {
      tg =
        "https://u3.huatu.com/uploads/allimg/230519/660725-2305191106094024685216.png";
    }
