...
<script>
    ...
    var city_tg = ['gz', 'sz', 'fs', 'dg', 'hz', 'zh', 'zs', 'qy', 'sg', 'st', 'sw', 'cz', 'jy', 'mz', 'hy', 'zj', 'zq', 'jm', 'yj', 'yf', 'mm', 'xg']

    var city = ''
    var city_code = ''
    // --如果条件满足，发起 AJAX 请求
    if (province == '广东省' || province == '香港') {
    ...
    function selectcode() {
        ...
        // console.log(code)
        $('#fromphonepic').attr('src', code) //--把页面中类名为wxewm的src的值设置为code的值！
    }
